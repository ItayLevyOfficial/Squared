export const LiquidityPool = ({ el, openModal }) => {
  ...
  return (
    <div className="bg-dark mb-6 max-w-main rounded-3xl flex flex-col w-full">
      ...
      <div className="w-full mb-2 flex justify-between items-center">
        <button
          ...
          className="ml-6 justify-center items-center bg-lightDark  text-white rounded-lg p-2 w-32 "
        >
          {button}
        </button>

        <div className="w-44 h-10 bg-lightDark flex justify-between items-center rounded-lg p-6 mr-6">
          <button className="px-2 -ml-4 h-6 flex justify-center items-center border-transparent bg-black text-white hover:bg-gold hover:text-black  rounded-lg">
            MAX
          </button>
          <input
            defaultValue={0}
